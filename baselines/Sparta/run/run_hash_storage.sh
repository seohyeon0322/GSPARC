...
# $SPARTA_DIR/build/benchmark/ttt -X $TENSOR_DIR/nips.bin -Y $TENSOR_DIR/nips.bin -m 2 -x 1 2 -y 1 2 -t 32;
# $SPARTA_DIR/build/benchmark/ttt -X $TENSOR_DIR/uber.bin -Y $TENSOR_DIR/uber.bin -m 2 -x 2 3 -y 2 3 -t 32 ;
# $SPARTA_DIR/build/benchmark/ttt -X $TENSOR_DIR/chicago.bin -Y $TENSOR_DIR/chicago.bin -m 2 -x 0 2 -y 0 2 -t 32 ;
# $SPARTA_DIR/build/benchmark/ttt -X $TENSOR_DIR/flickr-4d.bin -Y $TENSOR_DIR/flickr-4d.bin -m 2 -x 1 2 -y 1 2 -t 32 ;
# $SPARTA_DIR/build/benchmark/ttt -X $TENSOR_DIR/delicious.bin -Y $TENSOR_DIR/delicious.bin -m 2 -x 1 2 -y 1 2 -t 32 ;
# $SPARTA_DIR/build/benchmark/ttt -X $TENSOR_DIR/vast.bin -Y $TENSOR_DIR/vast.bin -m 2 -x 0 1 -y 0 1 -t 32 ;
...
# $SPARTA_DIR/build/benchmark/ttt -X $TENSOR_DIR/nips.bin -Y $TENSOR_DIR/nips.bin -m 3 -x 0 1 2 -y 0 1 2 -t 32 ;
...
# $SPARTA_DIR/build/benchmark/ttt -X $TENSOR_DIR/flickr-4d.bin -Y $TENSOR_DIR/flickr-4d.bin  -m 3 -x 0 1 2 -y 0 1 2 -t 32 ;
# $SPARTA_DIR/build/benchmark/ttt -X $TENSOR_DIR/delicious.bin -Y $TENSOR_DIR/delicious.bin -m 3 -x 0 1 2 -y 0 1 2 -t 32 ;
# $SPARTA_DIR/build/benchmark/ttt -X $TENSOR_DIR/vast.bin -Y $TENSOR_DIR/vast.bin -m 3 -x 0 1 3 -y 0 1 3 -t 32 ;
