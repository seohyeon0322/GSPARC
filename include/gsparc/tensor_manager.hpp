...
#define TENSOR_MANAGER_TEMPLATE_ARGS TensorType, SLITOMType
    ...
    public:
        ...
        void ExtractCOOCmodes(slitom_t *slitom);
        void ExtractBLCOKeys(slitom_t *slitom);
        void SortCOOPerPartition(slitom_t *slitom);
        void SortBLCOPerPartition(slitom_t *slitom);
